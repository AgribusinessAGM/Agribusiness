  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        I('Transporte interno', '€/Kg/\nAceitunas', 1, 0.01, [0, 0, 89.25, 107.1, 116.03].concat(Array(8).fill(133.88))),
        I('Transporte a planta central', '€/Kg/\nAceitunas', 1, 0.01, [0, 0, 89.25, 107.1, 116.03].concat(Array(8).fill(133.88))),
        I('Maquila', '€/Kg/\nAceitunas', 1, 0.03, [0, 0, 267.75, 321.3, 348.07].concat(Array(8).fill(401.63))),
      ],
    },
    {
      key: 'infra',
